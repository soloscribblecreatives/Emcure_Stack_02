...
function set_pg_content(pg_id) {
	...
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide2.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1080" height="810" alt=""></div><div class="hit_1"><img src="slide2/2.jpg" width="1080" height="810" alt=""/></div><div class="hit_pop1" onclick="hit_pop1()"></div><div class="hit_2"><img src="slide2/3.jpg" width="1080" height="810" alt=""/></div><div class="hit_pop2" onclick="hit_pop2()"></div><div class="hit_3"><img src="slide2/4.jpg" width="1080" height="810" alt=""/></div><div class="hit_pop3" onclick="hit_pop3()"></div><div class="hit_4"><img src="slide2/5.jpg" width="1080" height="810" alt=""/></div><div class="hit_pop4" onclick="hit_pop4()"></div><div class="hit_close1" onclick="hit_close1()"></div>';
	break;
	}
...
function hit_pop1() {
	$('.hit_1 img').css("display","block");
	$('.hit_close1').css("display","block");
	$('.hit_pop1').css("display","none");
}

function hit_pop2() {
	$('.hit_2 img').css("display","block");
	$('.hit_close1').css("display","block");
	$('.hit_pop2').css("display","none");
}

function hit_pop3() {
	$('.hit_3 img').css("display","block");
	$('.hit_close1').css("display","block");
	$('.hit_pop3').css("display","none");
}

function hit_pop4() {
	$('.hit_4 img').css("display","block");
	$('.hit_close1').css("display","block");
	$('.hit_pop4').css("display","none");
}

function hit_close1() {
	$('.hit_1 img').css("display","none");
